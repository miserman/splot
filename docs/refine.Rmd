...
```{r, fig.height=5, fig.width=10, dev='CairoSVG'}
splot(anger~index*name, points=FALSE, lines='loess', myl=c(0,2.2), colors=disp$col, lty=disp$lty, add={
    ...
    legend('topright', c('Adolf Hitler', 'Elliot Rodger'), lty=1:2, col=disp$col[grep('Hit|Rod', disp$name)], lwd=2, bty='n')
})
```
