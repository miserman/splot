...
This example tweaks a few results to prepare them for publication or whatever, using the dataset from a project comparing autobiographies ([osf.io/vwq9p](https://osf.io/vwq9p/)).
